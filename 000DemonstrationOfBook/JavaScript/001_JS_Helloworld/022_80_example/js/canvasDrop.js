...
//*********************** 定义核心对象 ********************
//1.Vector 速度对象，带有横向x,和纵向y的速度大小 单位为：V = 位移像素/帧 (记录下落对象drop的速度/V)
//2.Drop 下落物体对象， 即上面效果中的雨滴和雪， 在后面你也可自己拓展为陨石或者炮弹
//3.bounce 下落落地反弹对象， 即上面雨水反弹的水滴， 你也可后期拓展为反弹的碎石片或者烟尘
...
//*********************** Drop对象的update方法 (每一帧drop VS position) ********************
Drop.prototype.update = function() {
...
//*********************** 定义全局变量 ********************
// https://blog.csdn.net/xllily_11/article/details/51444311
//*********************** 定义全局变量 ********************